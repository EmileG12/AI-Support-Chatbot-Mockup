...
Renders a single ticket's category, priority, summary, and (when present) troubleshooting diagnostics and a duplicate-flag note. Used inline in the chat confirmation ([App](App.md)) and, via its exported label maps, in the [StaffDashboard](StaffDashboard.md).
